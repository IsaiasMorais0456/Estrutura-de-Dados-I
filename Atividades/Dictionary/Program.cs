...
{
    Console.WriteLine("Informe o código de rastreio");
    string RastreioCode = Console.ReadLine()!;
    Console.WriteLine("Informe o código de barras da encomenda");
    string Barracode = Console.ReadLine()!;

    try
    {
        logistics.Add(RastreioCode, Barracode);
        Console.WriteLine("Par código de rastreio - código de barras adicionado!");
    }
    catch (ArgumentException)
    {
        Console.WriteLine("Não é possível adicionar códigos de rastreio iguais.");
    }
    catch (Exception)
    {
...
while (true)
{
    ...
    if (logistics.ContainsKey(searchRastreio))
    {
        Console.WriteLine($"Achei! O código de barras para o código de rastreio {searchRastreio} é {logistics[searchRastreio]}");
    }
    else
    {
